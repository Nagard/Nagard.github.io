...
//			htm=htm+"<a onclick='document.getElementById('top-content').style.display='block' href='#"+i+"' >"+i+"</a> ";
				//console.log(i);
				htm=htm+"<a href='#"+i+"' >"+i+"</a> ";
...
function joinFirepadForHash() {
	...
	var ref = new Firebase('https://glowing-fire-1944.firebaseio.com/');
	// Attach an asynchronous callback to read the data at our posts reference
	daten = [];
	ref.on("value", function (snapshot) {
		snapshot.forEach(function (userSnap) {
			myArray[userSnap.key()] = 1;
